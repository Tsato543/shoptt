          ...
          <div className="mx-4 mt-4">
            <img 
             ...
             <p className="text-[10px] text-gray-500 text-center mt-2 px-2 leading-tight">
               Este valor é mais baixo porque este lote fazia parte do estoque interno destinado a funcionários da SlimHealth. Como restaram algumas unidades, a empresa decidiu liberar o último lote ao público mantendo o mesmo valor interno de R$ 67,67.
             </p>
          </div>
