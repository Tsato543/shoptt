...
const Upsell2 = () => {
  ...
  useEffect(() => {
    ...
    trackInitiateCheckout('upsell2-tenf', 'TENF Taxa de Nota Fiscal', AMOUNT);
  }, []);

  // Verifica se o usuário pagou o up1
  useEffect(() => {
    const up1Paid = localStorage.getItem('up1PaymentApproved');
    if (!up1Paid) {
  ...
  return (
    <div className="min-h-screen bg-secondary/30 flex flex-col">
      ...
      <div className="flex-1 p-4 space-y-4 max-w-md mx-auto w-full">
        ...
        <button
          onClick={() => {
            trackAddPaymentInfo('upsell2-tenf', 'TENF Taxa de Nota Fiscal', AMOUNT);
